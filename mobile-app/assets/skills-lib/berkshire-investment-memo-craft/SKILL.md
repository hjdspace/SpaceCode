---
name: berkshire-investment-memo-craft
...
This is a Codex-only hand-written skill kept under `codex-skills/` for simple installation. Do not add a same-named `berkshire-investment-memo-craft` source unless intentionally adopting this workflow for Claude Code too.
...
When the task requires fresh company research, first use the relevant .claude/skills/berkshire-shared/data/research skill and its validation requirements. Then use this skill to rewrite or structure the output as a memo.
