/**
 * Commands — WeChat bot command definitions
 */
...
export const WECHAT_KNOWN_COMMANDS: Set<string> = new Set(WECHAT_COMMANDS.map((c) => c.command))
...
export function isKnownCommand(command: string): boolean {
  return WECHAT_KNOWN_COMMANDS.has(command)
}
