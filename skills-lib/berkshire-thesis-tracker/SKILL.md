...
description: "AI Berkshire skill: 投资论文追踪：买入后的纪律系统. Source: berkshire-thesis-tracker."
---

## Codex adapter note

This skill is generated from `berkshire-thesis-tracker` so Claude Code and Codex users share one canonical workflow.
...
使用 `.claude/skills/berkshire-shared/tools/financial_rigor.py verify-valuation` 校验估值数据。
