...
const invokeApi = createRendererApi(
  ...
  getDiff: () => null,
  getRawDiff: () => '',
  stageHunks: () => ({ success: false, error: 'Git API not available' }),
  unstageHunks: () => ({ success: false, error: 'Git API not available' }),
  getCommitFiles: () => [],
  getCommitDiff: () => '',
  reset: () => ({ success: false, error: 'Git API not available' }),
  getFullDiff: () => null,
  getStagedDiff: () => '',
  showFile: () => null,
  getBranches: () => [],
