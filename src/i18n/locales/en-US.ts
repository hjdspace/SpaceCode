export default {
  ...
  rtk: {
    ...
    windowsNotice: 'Windows Platform Notice',
    windowsNoticeDesc: 'Windows native does not support automatic Hook rewriting. RTK will automatically switch to CLAUDE.md instruction injection mode. The AI will receive RTK usage instructions but needs to manually use the rtk command prefix. For full Hook support, use WSL.',
