// src/lib/petAnimation.ts
// 宠物精灵图集动画引擎。从 cc-haha 移植，去掉 React/服务端依赖，保留纯动画逻辑。
// 核心机制：8 列 × 11 行的 sprite atlas，通过 CSS background-position 切换帧。
...
export const PET_DRAG_DIRECTION_NONE = 'none' as const
export type PetDragDirection = typeof PET_DRAG_DIRECTION_NONE | 'left' | 'right'
