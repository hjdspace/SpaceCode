...
<template>
  <svg viewBox="0 0 100 60" width="80" height="48" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <!-- 身体立体渐变：棕色立体感 -->
      <radialGradient id="owlShade" cx="50%" cy="30%" r="70%">
    ...
    <!-- 接地阴影 -->
    <ellipse cx="50" cy="58" rx="25" ry="1.5" fill="rgba(0,0,0,0.25)" filter="url(#owlShadow)" />
    ...
    <g :transform="`translate(0, ${bodyOffsetY})`">
      ...
      <g :transform="leftWingTransform">
        ...
        <path d="M 28 30 Q 18 35 22 48 Q 28 44 32 38 Z" fill="url(#owlShade)" />
      </g>
      <g :transform="rightWingTransform">
        ...
        <path d="M 72 30 Q 82 35 78 48 Q 72 44 68 38 Z" fill="url(#owlShade)" />
      </g>

      <!-- 身体（圆胖，头身一体）+ rare 发光描边 -->
      <path d="M 28 35 Q 28 15 50 15 Q 72 15 72 35 Q 72 52 50 52 Q 28 52 28 35 Z" :fill="palette.primary" filter="url(#owlGlow)" />
      <path d="M 28 35 Q 28 15 50 15 Q 72 15 72 35 Q 72 52 50 52 Q 28 52 28 35 Z" fill="url(#owlShade)" />
