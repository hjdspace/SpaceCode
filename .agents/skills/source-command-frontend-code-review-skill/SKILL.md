---
name: "source-command-frontend-code-review-skill"
...
# source-command-frontend-code-review-skill

Use this skill when the user asks to run the migrated source command `frontend-code-review-SKILL`.
